// Generated from E:/IdeaWorkspace2/bigmother/hello-antle/src/main/java/club/ityuchao/g4/expr\LabeledExpr.g4 by ANTLR 4.7.2
package club.ityuchao.labeledExpr;
...
public class LabeledExprParser extends Parser {
	...
	public static class ParentsContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).enterParents(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).exitParents(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitParents(this);
			else return visitor.visitChildren(this);
		}
	}
